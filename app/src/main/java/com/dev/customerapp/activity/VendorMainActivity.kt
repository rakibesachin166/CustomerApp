...
import com.dev.customerapp.databinding.ActivityCustomerMainBinding
import com.dev.customerapp.databinding.ActivityVendorMainBinding
...
class VendorMainActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        userNameTxt.text = Constant(this).getVendorData().vendorName
    ...
    private val navListener = BottomNavigationView.OnNavigationItemSelectedListener { item ->
        ...
        when (item.itemId) {
            ...
            R.id.bottom_account -> {
                val userData = Constant(this@VendorMainActivity).getUserData()
                if (userData == null) {
